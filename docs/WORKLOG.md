...
- 2026-02-12: Fixed CI by correcting `setup-r-dependencies` inputs (`dependencies: hard/all` without extra quoting) and ensuring R-CMD-check installs `knitr`/`rmarkdown` so vignettes can build.
